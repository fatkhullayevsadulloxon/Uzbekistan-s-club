<template>
    <section class="master-residents-page mt-[150px]">
        <div class="container master-residents-page__container">
            ...
            <div class="master-residents-page__box">
...
.master-residents-page__input::placeholder {
    color: gray
}
