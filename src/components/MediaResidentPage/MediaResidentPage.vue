        ...
        <div class="container residents-page">
            <nav class="text-black 2xl:ms-0 xl:ms-0 lg:ms-0 md:ms-5 ms-5 my-8" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <RouterLink class="text-white font-[inter-medium]" :to="`/${$route.params.lan}/media-residents`">
            ...
            <div class="2xl:flex xl:flex lg:flex md:block block justify-between items-start mt-7">
                <div>
                    <div
                        ...
                        <div class="master-residents__list-radio">
                            ...
                            }" v-for="residentFieldToData in mediaReidentFieldTo" :key="residentFieldToData.id"
                ...
                <div>
                    <div class="who-rezident rounded-xl">
                        ...
                        <div class="ms-5">
                            <h4
                                class="absolute 2xl:mt-[-200px] xl:mt-[-200px] lg:mt-[-200px] md:mt-[-200px] mt-[-380px] 2xl:text-xl xl:text-xl lg:text-xl ms-5 md:text-xl text-[18px] text-white font-[inter-bold]">
                                {{ mediaResidents.title }}
                            </h4>
                            <div class="absolute 2xl:mt-[-150px] xl:mt-[-150px] lg:mt-[-150px] md:mt-[-150px] mt-[-330px] 2xl:max-w-[802px] xl:max-w-[802px] lg:max-w-[802px] md:max-w-[802px] max-w-[300px] who-rezident__short_bio ms-5"
                                v-html="mediaResidents.about">
                            </div>
                        </div>
                    </div>
                    <div
